...
class TestPreamblePromptLayering:
    ...
    def test_resume_preamble_appears_after_profile(self):
        ...
        # Factory ordering: profile < instruction < goal < resume
        ...
        assert profile_pos < instruction_pos
        assert profile_pos < goal_pos
